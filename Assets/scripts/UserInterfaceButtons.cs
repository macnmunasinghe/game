...
//	public GameObject Model;
	...
	{
		//lkh = GameObject.FindGameObjectsWithTag ("Model");
		//lkh.transform.localScale += new Vector3 (scalingSpeed, scalingSpeed, scalingSpeed);
		...
		//Debug.Log(GameObject.FindWithTag ("Model").name);
		}
